...
## windows
python -u src/main.py --model MLO --skip 5 --batch_size 16 --loss TCL --margin 4.0 --threshold 0.7 --slice_dir .\data\2D\ --remind_dir .\data\ReMIND_dataset\ReMIND-Manifest-Sept-2023\ReMIND\ --dist_flag l2 --patience 10 --load_slices
