...
python -u src/main.py --model MLO --skip 2 --batch_size 16 --loss TCL --threshold 0.15 --load_slices
python -u src/main.py --model MLO --skip 2 --batch_size 16 --loss TCL --threshold 0.25 --load_slices

#python -u src/main.py --model MLO --skip 1 --batch_size 16 --loss TCL --threshold 0.3 --slice_dir "./data/mri_data_and_models/2D" --load_slices
